    ...
    <header>
        <nav>
            ...
            <ul>
                ...
                <li class="lihead2" ><a class="aheader" href="upper.html">Upper Body</a></li>
                <li class="lihead2" ><a class="aheader" href="lower.html">Lower Body</a></li>
              ...
              <tr>
                ...
                <td>
                  <select name="clothing" id="select">
                    ...
                    <option value="JCK">JACKETS</option>
                    <option value="HDD">HODDIES</option>
                    <option value="SW">SWEATERS</option>
                    <option value="T-S">T-SHIRTS</option>
                  </select>  
                </td>
                <td>
